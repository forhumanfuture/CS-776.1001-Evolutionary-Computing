...
crossover_prob = 0.7
mutation_prob = 0.001
num_variables = 2  # Number of variables in the optimization problem
variable_range = (-2.048, 2.048)  # Range for each variable
...
# Function to evaluate the Rosenbrock Function (De Jong Function 2)
def evaluate_rosenbrock(solution):
    x, y = solution
...
for generation in range(num_generations):
    ...
    fitness_values = [evaluate_rosenbrock(individual) for individual in population]
...
best_fitness = evaluate_rosenbrock(best_solution)
