...
# Function to evaluate the Rastrigin Function (De Jong Function 4)
def evaluate_rastrigin(solution):
    n = len(solution)
...
for generation in range(num_generations):
    ...
    fitness_values = [evaluate_rastrigin(individual) for individual in population]
...
best_fitness = evaluate_rastrigin(best_solution)
